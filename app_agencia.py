...
Este vehículo ya se encuentra registrado en la base de datos de Carshield. El sistema le ha notificado a la agencia que el servicio ya estaba solicitado.
    ...
    with st.form("form_solicitud"):
        ...
        if submit:
            if solicitante and vendedor and correo_vendedor and vehiculo and modelo_auto:
                ...
                # Convertimos todo a mayúsculas y quitamos espacios extra para evitar errores comunes
                ...
                if vehiculo_limpio in vehiculos_existentes:
                    ...
                    # Si no es duplicado, procede a guardar normalmente
...
# ==========================================
    ...
    if not df.empty:
        ...
        st.info("La base de datos está vacía.") cl"""
...
Este vehículo ya se encuentra registrado en la base de so0licitudes de V clean. El sistema le ha notificado a la agencia que el servicio ya estaba solicitado.
